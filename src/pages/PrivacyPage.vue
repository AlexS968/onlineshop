      ...
      <div id="inputResult">
        ...
        <div class="row mb-4">
          <div class="col">
            ...
            <div class="descr">Настоящая политика обработки персональных данных составлена в
              ...
              предпринимаемые <strong>Интернет-магазином одежды MOIRE</strong>
              (далее – Оператор).
            </div>
            <div class="ol">
              <div class="li">
          ...
          <div class="col">
            ...
            <div class="ol">
              ...
              <div class="li">
                ...
                порядке, предусмотренном Законом о персональных данных (далее - персональные
          ...
          <div class="col">
            ...
            <div class="ol">
              ...
              <div id="generatedProcessingTargets">
                <div class="li">–
                  <mark>информирование Пользователя посредством отправки электронных писем</mark>
                  ;
                </div>
                <div class="li">–
                  <mark>заключение, исполнение и прекращение гражданско-правовых договоров;</mark>
                </div>
                <div class="li">–
                  <mark>
                    предоставление доступа Пользователю к сервисам, информации и/или материалам,
                    содержащимся на веб-сайте httpsː//technozavrrr.com;
                  </mark>
                </div>
                <div class="li">–
                  <mark>уточнение деталей заказа.</mark>
                </div>
              </div>
              <div class="li">
          ...
          <div class="col">
            ...
            <div class="ol">
              ...
              <div class="li">
                ...
                <span data-scroll-to="#prefixURL" class="link mark">
                  httpsː//technozavrrr.com/privacy
                </span>
                или направленные Оператору посредством электронной почты. Заполняя соответствующие
        ...
        <div class="row mb-4">
          <div class="col">
            ...
            <div class="ol">
              ...
              <div class="li">10.5. Вся информация, которая собирается сторонними сервисами, в том
        ...
        <div class="row mb-4">
          <div class="col">
            <h5>11. Перечень действий, производимых Оператором с полученными персональными данными
            </h5>
            <div class="ol">
              <div class="li">
              ...
              <div class="li">
                ...
                получением и/или передачей полученной информации по информационно-
          ...
          <div class="col">
            ...
            <div class="ol">
              <div class="li">
                ...
                электронной почты
                <span
                  data-scroll-to="#privacyEmail" class="link mark">privacy@technozavrrr.com</span>.
              </div>
              <div class="li">
              ...
              <div class="li">
                ...
                адресу
                <span id="genURLLink" data-scroll-to="#prefixURLLink" class="link mark">
                  httpsː//technozavrrr.com/privacy/
                </span>.
              </div>
            </div>
