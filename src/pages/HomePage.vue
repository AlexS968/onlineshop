            ...
            <li class="catalog__item">
              <a class="catalog__pic" href="#">
                <img src="img/product-3.jpg"
                     srcset="img/product-2@2x.jpg 2x" alt="Название товара">
              </a>
              ...
              <ul class="colors colors--black">
                <li class="colors__item">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio"
                           name="color-02" value="#F0F0F0" checked="">
                    <span class="colors__value" style="background-color: #F0F0F0;">
                  </span>
                  </label>
                </li>
            ...
            <li class="catalog__item">
              <a class="catalog__pic" href="#">
                <img src="img/product-4.jpg"
                     srcset="img/product-4@2x.jpg 2x" alt="Название товара">
              </a>
              ...
              <ul class="colors colors--black">
                <li class="colors__item">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio"
                           name="color-3" value="#939393" checked="">
            ...
            <li class="catalog__item">
              <a class="catalog__pic" href="#">
                <img src="img/product-5.jpg"
                     srcset="img/product-5@2x.jpg 2x" alt="Название товара">
              </a>
              ...
              <ul class="colors colors--black">
                <li class="colors__item">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio"
                           name="color-03" value="#939393" checked="">
                    <span class="colors__value" style="background-color: #939393;">
                  </span>
                  </label>
                </li>
            ...
            <li class="catalog__item">
              ...
              <ul class="colors colors--black">
                <li class="colors__item">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio"
                           name="color-04" value="#FFBE15" checked="">
            ...
            <li class="catalog__item">
              ...
              <ul class="colors colors--black">
                <li class="colors__item">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio"
                           name="color-4" value="#FFBE15" checked="">
                    <span class="colors__value" style="background-color: #FFBE15;">
                  </span>
                  </label>
                </li>
            ...
            <li class="catalog__item">
              <a class="catalog__pic" href="#">
                <img src="img/product-8.jpg"
                     srcset="img/product-8@2x.jpg 2x" alt="Название товара">
              </a>
              ...
              <ul class="colors colors--black">
                <li class="colors__item">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio"
                           name="color-5" value="#939393" checked="">
                    <span class="colors__value" style="background-color: #939393;">
                  </span>
                  </label>
                </li>
            ...
            <li class="catalog__item">
              <a class="catalog__pic" href="#">
                <img src="img/product-9.jpg"
                     srcset="img/product-9@2x.jpg 2x" alt="Название товара">
              </a>
              ...
              <ul class="colors colors--black">
                <li class="colors__item">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio"
                           name="color-6" value="#222" checked="">
                    <span class="colors__value" style="background-color: #222;">
                  </span>
                  </label>
                </li>
            ...
            <li class="catalog__item">
              <a class="catalog__pic" href="#">
                <img src="img/product-10.jpg"
                     srcset="img/product-10@2x.jpg 2x" alt="Название товара">
              </a>
              ...
              <ul class="colors colors--black">
                <li class="colors__item">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio"
                           name="color-7" value="#FFBE15" checked="">
                    <span class="colors__value" style="background-color: #FFBE15;">
                  </span>
                  </label>
                </li>
            ...
            <li class="catalog__item">
              <a class="catalog__pic" href="#">
                <img src="img/product-11.jpg"
                     srcset="img/product-11@2x.jpg 2x" alt="Название товара">
              </a>
              ...
              <ul class="colors colors--black">
                <li class="colors__item">
                  <label class="colors__label">
                    <input class="colors__radio sr-only" type="radio"
                           name="color-07" value="#FFBE15" checked="">
                    <span class="colors__value" style="background-color: #FFBE15;">
                  </span>
                  </label>
                </li>
            ...
            <li class="catalog__item">
              <a class="catalog__pic" href="#">
                <img src="img/product-12.jpg"
                     srcset="img/product-12@2x.jpg 2x" alt="Название товара">
              </a>
